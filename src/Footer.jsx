      ...
      <div className="footer-content">
        <div className="footer-top">
          <div className="footer-brand">
            <h2 className="footer-title">NexusWay.</h2>
          </div>
          <div className="footer-links">
            ...
            <div className="footer-link-section">
              ...
              <ul className="footer-link-list">
                <li><a href="/flights" className="footer-link">Flights</a></li>
                <li><a href="/logistics" className="footer-link">Logistics</a></li>
                <li><a href="/warehousing" className="footer-link">Warehousing</a></li>
              </ul>
            </div>
            <div className="footer-link-section">
        ...
        <div className="footer-bottom">
          <div className="footer-copyright">
            <p>&copy; 2026 NexusWay. All rights reserved.</p>
          </div>
